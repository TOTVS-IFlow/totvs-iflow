...
const cardsContent = [
  { title: "Reuniões", value: 3, description: "analisadas no período", icon: Mic, valueColor: "text-accent-500"},
  ...
  { title: "Riscos de churn", value: 0, description: "nível alto", icon: TriangleAlert, valueColor: "text-danger"}
];
